            ...
            <nav class="navbar bg-secondary navbar-white">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="/transaksi/transaksi.html" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Transaksi</a>
                    ...
                    <a href="/settings" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Settings</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
