        ...
        <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary text-center rounded p-4">
                ...
                <!-- Transaction Details Form -->
                    ...
                    <div class="mb-3">
                        <label for="source_bank" class="form-label">Sumber Bank</label>
                        <input type="text" class="form-control" id="source_bank" name="source_bank" required>
                    </div>
...
<!-- Form End -->
    ...
    <!-- AutoNumeric -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/autonumeric/4.0.9/autoNumeric.min.js"></script>

    <!-- Template Javascript -->
    <script src="js/main.js"></script>

    <!-- JavaScript untuk memformat input jumlah -->
    <script>
        ...
        new AutoNumeric('#amount', {
            ...
            digitGroupSeparator: '.',
            decimalPlaces: 2,
            unformatOnSubmit: true // Menghapus format sebelum mengirimkan data ke server
        });
    </script>
</body>
